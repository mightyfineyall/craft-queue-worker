...
PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bincront

##set your email address 
EMAIL="[NOTIFICATION EMAIL ADDRESS HERE]"

##list your services you want to check
SERVICES=( 'site-queue@1' 'site-queue@2' )  ## CentOS apache2 called httpd, if OS is other Linux you can give as apache2
